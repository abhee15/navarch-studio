...
export const DEFAULT_GRID_LAYOUTS: { lg: GridLayout[]; md: GridLayout[]; sm: GridLayout[] } = {
  lg: [
    ...
    { i: "bonjean", x: 0, y: 16, w: 6, h: 8, minW: 4, minH: 6 },
    { i: "waterlines-buttocks", x: 6, y: 16, w: 6, h: 8, minW: 4, minH: 6 },
    { i: "animated-waterplane3d", x: 0, y: 24, w: 12, h: 10, minW: 6, minH: 8 },
    { i: "table", x: 0, y: 34, w: 12, h: 8, minW: 6, minH: 4 },
  ...
  md: [
    ...
    { i: "bonjean", x: 0, y: 16, w: 5, h: 8, minW: 4, minH: 6 },
    { i: "waterlines-buttocks", x: 5, y: 16, w: 5, h: 8, minW: 4, minH: 6 },
    { i: "animated-waterplane3d", x: 0, y: 24, w: 10, h: 10, minW: 6, minH: 8 },
    { i: "table", x: 0, y: 34, w: 10, h: 8, minW: 5, minH: 4 },
  ...
  sm: [
    ...
    { i: "bonjean", x: 0, y: 22, w: 6, h: 8, minW: 6, minH: 6 },
    { i: "waterlines-buttocks", x: 0, y: 30, w: 6, h: 8, minW: 6, minH: 6 },
    { i: "animated-waterplane3d", x: 0, y: 38, w: 6, h: 10, minW: 6, minH: 8 },
    { i: "table", x: 0, y: 48, w: 6, h: 8, minW: 6, minH: 4 },
...
export const PANEL_DEFINITIONS: Partial<Record<PanelId, PanelDefinition>> = {
  ...
  bonjean: {
    id: "bonjean",
    title: "Bonjean Curves",
    description: "Sectional area curves at each station",
    icon: "chart-line",
    defaultSize: { w: 6, h: 8, minW: 4, minH: 6 },
    availableInMobile: false,
  },
  ...
  "animated-waterplane3d": {
    id: "animated-waterplane3d",
    title: "Animated Waterplane 3D",
    description: "3D visualization with draft animation and hydrostatics HUD",
    icon: "waves",
...
export const LAYOUT_PRESETS: LayoutPreset[] = [
  {
    id: "default",
    name: "Default",
    description: "Compact layout with all panels visible",
    layout: {
      mode: "view",
      gridLayouts: {
        lg: [
          { i: "kpis", x: 0, y: 0, w: 12, h: 2, minW: 6, minH: 2 },
          { i: "curves", x: 0, y: 2, w: 6, h: 5, minW: 4, minH: 4 },
          { i: "hull", x: 6, y: 2, w: 3, h: 5, minW: 3, minH: 4 },
          { i: "status", x: 9, y: 2, w: 3, h: 2, minW: 3, minH: 2 },
          { i: "parameters", x: 9, y: 4, w: 3, h: 3, minW: 3, minH: 3 },
          { i: "vessel3d", x: 0, y: 7, w: 6, h: 6, minW: 4, minH: 5 },
          { i: "bodyplan", x: 6, y: 7, w: 6, h: 6, minW: 4, minH: 5 },
          { i: "table", x: 0, y: 13, w: 9, h: 5, minW: 6, minH: 4 },
          { i: "geometry", x: 9, y: 13, w: 3, h: 3, minW: 3, minH: 3 },
          { i: "animated-waterplane3d", x: 0, y: 18, w: 12, h: 8, minW: 6, minH: 6 },
        ],
        md: [
          { i: "kpis", x: 0, y: 0, w: 10, h: 2, minW: 5, minH: 2 },
          { i: "curves", x: 0, y: 2, w: 5, h: 5, minW: 4, minH: 4 },
          { i: "hull", x: 5, y: 2, w: 5, h: 5, minW: 3, minH: 4 },
          { i: "status", x: 0, y: 7, w: 3, h: 2, minW: 3, minH: 2 },
          { i: "parameters", x: 3, y: 7, w: 3, h: 3, minW: 3, minH: 3 },
          { i: "geometry", x: 6, y: 7, w: 4, h: 3, minW: 3, minH: 3 },
          { i: "vessel3d", x: 0, y: 10, w: 5, h: 6, minW: 4, minH: 5 },
          { i: "bodyplan", x: 5, y: 10, w: 5, h: 6, minW: 4, minH: 5 },
          { i: "table", x: 0, y: 16, w: 10, h: 5, minW: 5, minH: 4 },
          { i: "animated-waterplane3d", x: 0, y: 21, w: 10, h: 8, minW: 6, minH: 6 },
        ],
        sm: [
          { i: "kpis", x: 0, y: 0, w: 6, h: 2, minW: 6, minH: 2 },
          { i: "curves", x: 0, y: 2, w: 6, h: 5, minW: 6, minH: 4 },
          { i: "hull", x: 0, y: 7, w: 6, h: 5, minW: 6, minH: 4 },
          { i: "vessel3d", x: 0, y: 12, w: 6, h: 6, minW: 6, minH: 5 },
          { i: "bodyplan", x: 0, y: 18, w: 6, h: 6, minW: 6, minH: 5 },
          { i: "table", x: 0, y: 24, w: 6, h: 5, minW: 6, minH: 4 },
          { i: "animated-waterplane3d", x: 0, y: 29, w: 6, h: 8, minW: 6, minH: 6 },
          { i: "status", x: 0, y: 37, w: 6, h: 2, minW: 6, minH: 2 },
          { i: "parameters", x: 0, y: 39, w: 6, h: 3, minW: 6, minH: 3 },
          { i: "geometry", x: 0, y: 42, w: 6, h: 3, minW: 6, minH: 3 },
        ],
      },
      panelStates: {
...
export const RESISTANCE_PANEL_DEFINITIONS: Partial<Record<PanelId, PanelDefinition>> = {
  ...
  "resistance-breakdown": {
    id: "resistance-breakdown",
    title: "Resistance Breakdown",
    description: "Sparklines table showing resistance components by speed",
    icon: "table",
...
export const RESISTANCE_DEFAULT_GRID_LAYOUTS: {
  ...
  lg: [
    ...
    { i: "resistance-breakdown", x: 4, y: 12, w: 8, h: 6, minW: 8, minH: 4 },
    { i: "resistance-power-results", x: 4, y: 18, w: 8, h: 6, minW: 6, minH: 4 },
    { i: "resistance-charts", x: 4, y: 24, w: 8, h: 8, minW: 8, minH: 6 },
    { i: "resistance-unified-summary", x: 0, y: 32, w: 12, h: 8, minW: 8, minH: 6 },
  ],
  md: [
    ...
    { i: "resistance-breakdown", x: 3, y: 12, w: 7, h: 6, minW: 7, minH: 4 },
    { i: "resistance-power-results", x: 3, y: 18, w: 7, h: 6, minW: 5, minH: 4 },
    { i: "resistance-charts", x: 0, y: 24, w: 10, h: 8, minW: 8, minH: 6 },
    { i: "resistance-unified-summary", x: 0, y: 32, w: 10, h: 8, minW: 8, minH: 6 },
  ],
  sm: [
    ...
    { i: "resistance-breakdown", x: 0, y: 30, w: 6, h: 6, minW: 6, minH: 4 },
    { i: "resistance-power-results", x: 0, y: 36, w: 6, h: 6, minW: 6, minH: 4 },
    { i: "resistance-charts", x: 0, y: 42, w: 6, h: 8, minW: 6, minH: 6 },
    { i: "resistance-unified-summary", x: 0, y: 50, w: 6, h: 8, minW: 6, minH: 6 },
  ],
};

...
import { ResistanceWorkspaceLayout } from "../../components/resistance/ResistanceWorkspaceLayout";

export const VesselResistanceWorkspace = observer(function VesselResistanceWorkspace() {
  ...
  return (
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      {/* Workspace Content */}
      <ResistanceWorkspaceLayout vessel={vessel} onBack={handleBack} onVesselUpdated={loadVessel} />

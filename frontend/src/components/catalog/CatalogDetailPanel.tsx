...
import { X, Copy, ExternalLink, CheckCircle, XCircle } from "lucide-react";
...
export const CatalogDetailPanel: React.FC<CatalogDetailPanelProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`
          fixed right-0 top-0 h-full w-full sm:w-[500px] bg-white dark:bg-gray-900
      ...
      >
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {hull.beam != null && (
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Beam (B)</div>
                  <div className="text-base font-semibold text-gray-900 dark:text-white">
              ...
              {hull.draft != null && (
                <div>
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Draft (T)</div>
                  <div className="text-base font-semibold text-gray-900 dark:text-white">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">{hull.units}</span>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="sticky bottom-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 px-6 py-4 space-y-3">
          ...
          <Button variant="outline" className="w-full" onClick={() => onViewDetails?.(hull)}>

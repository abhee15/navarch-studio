...
export const ConsolidatedHydrostaticsTab = observer(
  ({ vesselId, vessel }: ConsolidatedHydrostaticsTabProps) => {
    // State
    ...
    return (
      <div className="h-full flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-900">
        {/* TOP TOOLBAR */}
        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-3 py-2 flex items-center gap-3 flex-shrink-0">
          {/* Vessel Selector */}
          <div className="flex items-center gap-1.5">
            <label className="text-xs font-medium text-gray-600 dark:text-gray-400">Vessel:</label>
            <div className="px-2 py-1 bg-gray-50 dark:bg-gray-700 rounded text-xs font-medium text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-600">
              {vessel?.name || "Unknown"}
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded text-xs py-1 px-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            >
          ...
          {/* Presets */}
          <div className="flex items-center gap-1.5">
            <label className="text-xs font-medium text-gray-600 dark:text-gray-400">Presets:</label>
            <select className="border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded text-xs py-1 px-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
          ...
          <button
            ...
            disabled={computing}
            className="ml-auto inline-flex items-center px-4 py-1.5 border border-transparent text-xs font-semibold rounded shadow-sm text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {computing ? (
              <>
                <svg
          ...
          <button
            ...
            className="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-xs font-medium rounded shadow-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
            title="Export hydrostatic data"
          >
            <svg
        ...
        {/* Error Message */}
        {error && (
          <div className="bg-red-50 dark:bg-red-900/30 border-l-4 border-red-400 dark:border-red-600 p-2 mx-3 mt-2 flex-shrink-0">
            <div className="flex">
              <svg
                className="h-3.5 w-3.5 text-red-400 dark:text-red-500 flex-shrink-0"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
              ...
              <p className="ml-2 text-xs text-red-700 dark:text-red-300">{error}</p>
            </div>
          </div>
        )}
        ...
        <div className="flex-1 flex gap-0 overflow-hidden">
          {/* LEFT PANEL: Inputs */}
          <div className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 overflow-y-auto overflow-x-hidden">
            {/* Geometry & Reference */}
          ...
          <div className="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900">
            {results.length > 0 && currentResult ? (
              <div className="flex flex-col">
                  ...
                  <div className="grid grid-cols-6 gap-3 text-center">
                    <div>
                      ...
                      <div className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                        {formatNumber(currentResult.dispWeight, 0)} {massUnit}
                      </div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase">
                      ...
                      <div className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                        {formatNumber(currentResult.draft)} {lengthUnit}
                      </div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase">
                      ...
                      <div className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                        {formatNumber(currentResult.bMt)} {lengthUnit}
                      </div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase">
                      ...
                      <div className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                        {formatNumber(currentResult.gMt)} {lengthUnit}
                      </div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase">
                      ...
                      <div className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                        {formatNumber(currentResult.lCBx)} {lengthUnit}
                      </div>
                    </div>
                    <div>
                      <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase">
                      ...
                      <div className="text-xs font-semibold text-gray-900 dark:text-gray-100">
                        {formatNumber(currentResult.awp, 1)} {areaUnit}
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setSelectedCurveType(
                          e.target.value as "hydrostatic" | "bonjean" | "cross-curves"
                        )
                      }
                      className="border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 rounded text-xs py-0.5 px-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    >
                ...
                {/* Hydrostatic Table */}
                <div className="bg-white dark:bg-gray-800 m-3 mt-0 p-3 rounded border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-xs">
                      <thead className="bg-gray-50 dark:bg-gray-900">
                        <tr>
                          <th className="px-2 py-1 text-left text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase">
                            Draft
                          </th>
                          <th className="px-2 py-1 text-left text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase">
                            Displ.
                      ...
                      <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                        {results.map((result, idx) => (
                          ...
                          >
                            ...
                            <td className="px-2 py-1 whitespace-nowrap text-gray-900 dark:text-gray-100">

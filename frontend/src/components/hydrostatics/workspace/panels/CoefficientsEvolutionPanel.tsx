...
const TYPICAL_RANGES: Record<
  string,
  { cb: [number, number]; cp: [number, number]; cm: [number, number]; cwp: [number, number] }
> = {
  ...
  ({ vessel, results, onDraftHover }: CoefficientsEvolutionPanelProps) => {
    ...
    return (
      <div className="h-full flex flex-col">
        ...
        {vessel?.metadata?.vesselType && vessel.metadata.vesselType in TYPICAL_RANGES && (

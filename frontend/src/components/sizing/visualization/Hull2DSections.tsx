              ...
              {section.points.length > 1 && (
                <g>
                  ...
                  {isHovered && (
                    <g>
                      <rect
                        x={toSVG(section.points[0][0], section.points[0][1], section.isAft)[0] - 40}
                        y={toSVG(section.points[0][0], section.points[0][1], section.isAft)[1] - 30}
                        width="80"
                        height="16"
                        rx="3"
                        fill="#1f2937"
                      ...
                      <text
                        x={toSVG(section.points[0][0], section.points[0][1], section.isAft)[0]}
                        y={toSVG(section.points[0][0], section.points[0][1], section.isAft)[1] - 19}
                        textAnchor="middle"
                        fill="#ffffff"
                        style={{ fontSize: "9px" }}
                      >

...
namespace DataService.Migrations
{
    ...
    public partial class SeedBenchmarkData : Migration
    {
        ...
        {
            // Seed 9 benchmark hulls from SIMMAN/ITTC/DARPA datasets
            migrationBuilder.Sql(@"
                ...
                VALUES
                -- KVLCC2 Full Scale (SIMMAN 2008)
                (gen_random_uuid(), 'KVLCC2', 'Tanker', 320.0, 58.0, 20.8, 23.92, 320115, 0.8098, 0.8598, 0.9418, 'SIMMAN_2008', true, 'Reference', NOW(), NOW()),
                
                -- KVLCC2 Model Scale (1:100)
                (gen_random_uuid(), 'KVLCC2_Model', 'Tanker', 3.2, 0.58, 0.208, 0.2392, 320.115, 0.8098, 0.8598, 0.9418, 'SIMMAN_2008', true, 'Reference', NOW(), NOW()),
                
                -- KCS Full Scale (SIMMAN 2008)
                (gen_random_uuid(), 'KCS', 'Container', 230.0, 32.2, 10.8, 13.5, 53281, 0.6505, 0.7005, 0.9286, 'SIMMAN_2008', true, 'Reference', NOW(), NOW()),
                
                -- KCS Model Scale (1:100)
                (gen_random_uuid(), 'KCS_Model', 'Container', 2.3, 0.322, 0.108, 0.135, 53.281, 0.6505, 0.7005, 0.9286, 'SIMMAN_2008', true, 'Reference', NOW(), NOW()),
                
                -- DTMB 5415 Full Scale (SIMMAN 2014)
                (gen_random_uuid(), 'DTMB5415', 'Combatant', 142.0, 19.06, 6.16, 8.316, 8636, 0.506, 0.586, 0.8635, 'SIMMAN_2014', true, 'Reference', NOW(), NOW()),
                
                -- DTMB 5415 Model Scale (1:46.6)
                (gen_random_uuid(), 'DTMB5415_Model', 'Combatant', 3.048, 0.409, 0.132, 0.1782, 86.36, 0.506, 0.586, 0.8635, 'SIMMAN_2014', true, 'Reference', NOW(), NOW()),
                
                -- ONR Tumblehome (SIMMAN 2014)
                ...
                -- KRISO Container Ship (SIMMAN 2020)
                (gen_random_uuid(), 'KRISO_Container_Ship', 'Container', 175.0, 25.4, 9.5, 11.875, 25215, 0.600, 0.680, 0.8824, 'SIMMAN_2020', true, 'Reference', NOW(), NOW()),
                
                -- SUBOFF Submarine (DARPA)
            ...
            // Seed 19 benchmark test conditions
            migrationBuilder.Sql(@"
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                ...
                WHERE vessel_id IN ('KVLCC2', 'KVLCC2_Model', 'KCS', 'KCS_Model', 'DTMB5415', 'DTMB5415_Model', 'ONR_Tumblehome', 'KRISO_Container_Ship', 'SUBOFF');
            ");

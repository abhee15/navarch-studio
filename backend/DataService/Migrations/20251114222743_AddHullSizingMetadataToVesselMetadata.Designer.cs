...
namespace DataService.Migrations
{
    ...
    [Migration("20251114222743_AddHullSizingMetadataToVesselMetadata")]
    partial class AddHullSizingMetadataToVesselMetadata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.Models.Vessel", b =>
                {
                    ...
                    b.Property<Guid?>("OriginCandidateId")
                        .HasColumnType("uuid")
                        .HasColumnName("origin_candidate_id");

                    b.Property<DateTime?>("OriginCreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("origin_created_at");

                    b.Property<string>("OriginDesignName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("origin_design_name");

                    b.Property<string>("OriginIdempotencyKey")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("origin_idempotency_key");

                    b.Property<Guid?>("OriginMissionCaseId")
                        .HasColumnType("uuid")
                        .HasColumnName("origin_mission_case_id");

                    b.Property<string>("OriginMissionName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("origin_mission_name");

                    b.Property<string>("OriginRunName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("origin_run_name");

                    b.Property<Guid?>("OriginSizingRunId")
                        .HasColumnType("uuid")
                        .HasColumnName("origin_sizing_run_id");
                    ...
                    b.Property<string>("OriginUserDisplayName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("origin_user_display_name");

                    b.Property<Guid?>("OriginUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("origin_user_id");

                    b.Property<DateTime?>("PushedToHydrostaticsAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("pushed_to_hydrostatics_at");

                    b.Property<string>("ShipdBowFamily")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("shipd_bow_family");

                    b.Property<string>("ShipdCategory")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("shipd_category");

                    b.Property<int?>("ShipdMaskVersion")
                        .HasColumnType("integer")
                        .HasColumnName("shipd_mask_version");

                    b.Property<string>("ShipdMidshipFamily")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("shipd_midship_family");

                    b.Property<string>("ShipdParametersJson")
                        .HasColumnType("jsonb")
                        .HasColumnName("shipd_parameters_json");

                    b.Property<string>("ShipdSternFamily")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("shipd_stern_family");

                    b.Property<string>("ShipdType")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("shipd_type");

                    b.Property<string>("ShipdTypeDisplayName")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)")
                        .HasColumnName("shipd_type_display_name");
                    ...
                    b.HasIndex("OriginCandidateId")
                        .HasDatabaseName("ix_vessels_origin_candidate_id");

                    b.HasIndex("OriginMissionCaseId")
                        .HasDatabaseName("ix_vessels_origin_mission_case_id");

                    b.HasIndex("OriginSizingRunId")
                        .HasDatabaseName("ix_vessels_origin_sizing_run_id");

                    b.HasIndex("ShipdType")
                        .HasDatabaseName("ix_vessels_shipd_type");

...
namespace DataService.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "benchmark_test_conditions",
                schema: "catalog_real",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    test_type = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    hull_name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    speed_knots = table.Column<decimal>(type: "numeric", nullable: false),
                    froude_number = table.Column<decimal>(type: "numeric", nullable: false),
                    reynolds_number = table.Column<decimal>(type: "numeric", nullable: false),
                    wave_height_m = table.Column<decimal>(type: "numeric", nullable: false),
                    wave_period_s = table.Column<decimal>(type: "numeric", nullable: false),
                    heading_deg = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_benchmark_test_conditions", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    vessel_id = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    vessel_type = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    lpp_m = table.Column<decimal>(type: "numeric(10,3)", nullable: false),
                    beam_m = table.Column<decimal>(type: "numeric(10,3)", nullable: false),
                    draft_m = table.Column<decimal>(type: "numeric(10,3)", nullable: false),
                    depth_m = table.Column<decimal>(type: "numeric(10,3)", nullable: true),
                    displacement_t = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    cb = table.Column<decimal>(type: "numeric(5,4)", nullable: false),
                    cp = table.Column<decimal>(type: "numeric(5,4)", nullable: true),
                    cm = table.Column<decimal>(type: "numeric(5,4)", nullable: true),
                    cw = table.Column<decimal>(type: "numeric(5,4)", nullable: true),
                    service_speed_ms = table.Column<decimal>(type: "numeric(6,3)", nullable: true),
                    ...
                    data_quality = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    resistance_curve = table.Column<string>(type: "jsonb", nullable: true),
                    hull_geometry_file = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    is_system_data = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_vessels_real", x => x.id);
                });

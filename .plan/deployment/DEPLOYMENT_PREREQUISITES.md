...
- **[Phase 4: AWS Setup](.plan/phases/phase4-aws-setup.md)** - Detailed setup guide
- **[Phase 4: Quick Start](.plan/phases/phase4-quick-start.md)** - Fast reference
- **[GitHub Secrets](docs/GITHUB_SECRETS.md)** - Complete secrets reference
- **[IAM Setup](.plan/deployment/IAM_SETUP.md)** - Required AWS permissions

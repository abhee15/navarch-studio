...
2. **Use least privilege AWS credentials**
   ...
   - Attach only necessary policies (see `.plan/deployment/IAM_SETUP.md`)
...
**Solution:** Review IAM policy in `.plan/deployment/IAM_SETUP.md` and ensure all permissions are granted.

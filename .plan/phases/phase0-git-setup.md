...
1. **Complete Phase 0 (Foundation)**
   - Follow the steps in `.plan/phases/phase0-git-setup.md`
   - Create folder structure and Git configuration
   
2. **Proceed to Phase 1**
   - See `.plan/phases/phase1-local-stack.md`
...
- **[Phase 1: Local Development Stack](.plan/phases/phase1-local-stack.md)**
